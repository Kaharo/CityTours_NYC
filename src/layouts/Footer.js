...
export default function Footer() {
  return (
    <footer class="relative px-2 z-10 bg-slate-100 pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        ...
        <div class="-mx-4 flex flex-wrap">
            ...
            <div class="mb-10 w-full">
              ...
              <div className="flex">
                <svg
                  ...
                  stroke="#1F2937"
                  class="mb-6 inline-block max-w-[60px]"
                >
                ...
                <h2 class="text-4xl mx-2 my-3">City Tours</h2>
              </div>
              <p class="text-body-color mb-7 text-base">
                We are open to all possible collaborations
              </p>
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div class="mb-10 w-full">
              ...
              <ul>
                ...
                <li>
                  <a
                    href="https://www.meetup.com/lp/how-to-group-start?utm_medium=SEM&utm_source=google&utm_campaign=mmrk_adwords_orgacq_us_branded_ny23&utm_term=group&utm_content=lp_grp_v2&gclid=CjwKCAiAlp2fBhBPEiwA2Q10D4ThwM42E46HS4mU-h_Tu2YqE0emxoD5OdqYDxl_v01kXrd87XwH0BoC7moQAvD_BwE"
                    class="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose"
                  >
                    Meet up
                  </a>
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div class="mb-10 w-full">
              ...
              <p class="text-body-color text-base">&copy; 2023 CityTours</p>
            </div>
          </div>
        </div>
      </div>
