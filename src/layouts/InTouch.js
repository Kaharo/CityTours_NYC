          ...
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              ...
              <p class="text-body-color mb-9 text-base leading-relaxed">
                We are passionate about traveling, exploring world-known
                attractions, connect to new people, know more about different
                cultures and find the gems of the world. Write us if you have
                ideas, suggestions, proposals or anything else, even with the
                complaint (try to be constructive) we would love to hear all of
                it)
              </p>
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-body-color text-base">
                    Currently without a definite address, but soon there will be
                    one
                  </p>
                </div>
              </div>
              {/* <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-body-color text-base">(+7)81 414 257 9980</p>
                </div>
              </div> */}
              <div class="mb-8 flex w-full max-w-[370px]">
                <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-body-color text-base">kaharema@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
